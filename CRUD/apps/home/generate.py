...
def exec_sql_file(user, sql_file):
    ...
    print "\n[INFO] Ejecutando el archivo: '%s'" % (sql_file)
    statement = ""
        ...
        if not re.search(r'[^-;]+;', line):  # keep appending lines that don't end in ';'
            ...
            if re.search(r'CREATE TABLE', statement):
                ...
                try:
                    ...
                    print "Lo sentimos, ya existe esa tabla. Intenta con un nuevo archivo.", e
            else:
...
from CRUD.apps.inspectdb.management.commands import inspectdb
import zipfile
